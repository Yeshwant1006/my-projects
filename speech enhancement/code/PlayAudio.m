classdef PlayAudio < handle
    ...
    methods (Access = private)
        ...
        function InitializeGUI(this)
            ...
            title(this.ax1,'Speech Enhancement Using Combination of Digital Audio','FontSize',this.FONT_SIZE);
            ...
            title(this.ax2,'Spectogram of Kalman','FontSize',this.FONT_SIZE);
